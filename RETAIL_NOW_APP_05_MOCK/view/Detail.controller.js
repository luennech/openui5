sap.ui.core.mvc.Controller.extend("RETAIL_NOW_APP.view.Detail", {
...
// 1. Kopie aus TEST_Association_10 Master2.controller
	...
	onRouteMatched : function(oEvent) {
		...
		if (oParameters.name === "detail" && jQuery.device.is.phone) { 
    		this.getRouter().myNavToWithoutHash({ 
    			...
    			targetViewName : "RETAIL_NOW_APP_05.view.Detail",
    			targetViewType : "XML",
    			transition : "slide"
    		});
		}
...
// 2. Kopie aus TEST_Association_10 Master2.controller
//
//	onRouteMatched : function(oEvent) {
//		var oParameters = oEvent.getParameters();
//
...
//			var oEventBus = this.getEventBus();
//			var that = this;
//			this.byId("listKV").attachUpdateFinished(function(){
//    			    that.selectFirstItem();
//                	oEventBus.publish("detail", "LoadFinished",{
//                		oListItem: that.getView().byId("listKV").getItems()[0]
//			    });
//			});
//		}
//
...
// Ende 2. Kopie
	...
	showEmptyView : function () {
		this.getRouter().myNavToWithoutHash({ 
			currentView : this.getView(),
			targetViewName : "RETAIL_NOW_APP.view.NotFound",
			targetViewType : "XML"
		});
	},
