sap.ui.core.mvc.Controller.extend("RETAIL_NOW_APP.view.Master", {
	...
	loadDetailView : function(){
		this.getRouter().myNavToWithoutHash({ 
			...
			targetViewName : "RETAIL_NOW_APP.view.Detail",
			targetViewType : "XML"
		});
	},
	...
	onSearch : function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [ new sap.ui.model.Filter("NAMEKOMP", sap.ui.model.FilterOperator.Contains, searchString) ];
		}
		// Update list binding
